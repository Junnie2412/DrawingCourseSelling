<%-- 
    Document   : blog
    Created on : Sep 25, 2023, 8:33:29 AM
    Author     : Admin
--%>
                        ...
                        <article class="pr-xl-20 blog-posts">
                            <div class="post-item">
                                ...
                                <div class="post-content">
                                    <h4 class="title">
                                        <a href="blog-details.jsp">How to become a best sale marketer in a year!</a>
                                    </h4>
                                    <p>
                                        This response is important for our ability to learn from mistakes, but it alsogives criticism, because it is part of the threat-protection system. In other words. One touch of a red-hot stove is usually all we need to avoid that kind of discomfort in future. The same is true as we experience the emotional sensation.
                                    </p>
                                    <a href="#0" class="read-more">Read More <i class="fa fa-angle-right"></i></a>
                                    <div class="meta">
                                        <div class="meta-area">
                                            <a href="#0"><i class="far fa-user"></i>Samanta Islam</a>
                            ...
                            <div class="post-item">
                                ...
                                <div class="post-content">
                                    <h4 class="title">
                                        <a href="blog-details.jsp">How to become a best development in a year!</a>
                                    </h4>
                                    <p>
                                        This response is important for our ability to learn from mistakes, but it alsogives criticism, because it is part of the threat-protection system. In other words. One touch of a red-hot stove is usually all we need to avoid that kind of discomfort in future. The same is true as we experience the emotional sensation.
                                    </p>
                            ...
                            <div class="footer-widget widget-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <a href="Mailto:info@exampleweb.com"><span class="__cf_email__" data-cfemail="c8a1a6aea788adb0a9a5b8a4adbfadaae6aba7a5">[email&#160;protected]</span></a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
