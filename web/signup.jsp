            ...
            <div class="container">
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.jsp" class="d-inline-block auth-logo">
                                    <img src="admin/assets/images/art1.png"  alt="logo" height="90">
                                </a>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <form action="MainController" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="useremail" placeholder="Enter email address" name="useremail" required>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Already have an account ? <a href="signin.jsp" class="fw-semibold text-primary text-decoration-underline"> Signin </a> </p>
                        </div>
