                ...
                <div class="container">
                    <div class="banner-content cl-white">
                        ...
                        <div class="banner-button-area">
                            <a href="courses.jsp" class=" btn-md btn-viewCourse">view courses <i class="fas fa-play-circle"></i></a>
                            <a href="signup.jsp" class="btn-createAccount btn-md theme-one">Create your account <i class="flaticon-tap-1"></i></a>
                            <% } else { %><div class="banner-button-area">
                                <a href="courses.jsp" class=" btn-md btn-viewCourse">
