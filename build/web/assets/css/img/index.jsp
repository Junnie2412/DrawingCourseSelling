    ...
    <div class="all-sections">
                ...
                <div class="header-area">
                    ...
                    <ul class="menu d-none d-lg-flex flex-wrap">
                        ...
                        <li>
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="blog.jsp">Post</a>
                                </li>
                                <li>
                                    <a href="blog-details.jsp">Post Details</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                    ...
                    <a href="login19.jsp" class="custom-button"><i class="fas fa-user"></i><span>Sign Up Here</span></a>
                </div>
            </div>
        </header>
        <!-- ~~~ Header Section ~~~ -->
        ...
        <div class="mobile-menu">
            ...
            <div class="w-100 d-flex flex-wrap justify-content-center align-items-center">
                ...
                <a href="#0" class="custom-button"><i class="fas fa-user"></i><span>Sign Up Here</span></a>
                            ...
                            <div class="footer-widget widget-info">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <a href="Mailto:info@exampleweb.com"><span class="__cf_email__" data-cfemail="5f363139301f3a273e322f333a283a3d713c3032">[email&#160;protected]</span></a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
