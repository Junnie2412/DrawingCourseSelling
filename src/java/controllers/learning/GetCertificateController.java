 ...
 * @author HOANG DUNG
 */
@WebServlet(name = "GetCertificateController", urlPatterns = {"/GetCertificateController"})
public class GetCertificateController extends HttpServlet {

    private static final String ERROR = "learning.jsp";
    private static final String SUCCESS = "certificateDetail.jsp";
